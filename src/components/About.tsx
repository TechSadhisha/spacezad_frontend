        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:pl-8">
            ...
            <div className="space-y-6 text-muted-foreground luxury-body text-lg">
              <p>
                As Austin's premier luxury real estate professional, I bring
                over two decades of experience in representing the city's most
              ...
              <p>
                ...
                Austin's most influential families and investors. Whether you're
              ...
              <p>
                Having facilitated over $2.5 billion in sales, I understand that
                luxury real estate is not just about properties—it's about
